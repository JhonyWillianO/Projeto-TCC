...
if (tiro_level >= 1)
instance_create_layer(x+3,y-28,layer, obj_tiro); 

if (tiro_level >= 2)
instance_create_layer(x+5,y-15,layer, obj_tiro_2); 

if (tiro_level >= 3){
var _tiro2 = instance_create_layer(x+5,y-15,layer, obj_tiro_2); 
